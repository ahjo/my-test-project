...
function TinyMCE_imanager_execCommand(editor_id, element, command, user_interface, value) {
	// Handle commands
	switch (command) {
		case "mceBrowseImage":
			var template = new Array();

			template['file'] = '../../plugins/imanager/imanager.php'; // Relative to theme location
			template['width'] = 400;
			template['height'] = 400;
